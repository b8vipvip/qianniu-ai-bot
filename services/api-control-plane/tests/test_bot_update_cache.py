...
def sample_metadata(module, payload: bytes = b"verified-package"):
    return {
        ...
        "notes": "test",
        "html_url": "https://github.com/b8vipvip/qianniu-ai-bot/releases/tag/bot-v1.1.600",
        "download_url": "https://github.com/b8vipvip/qianniu-ai-bot/releases/download/bot-v1.1.600/qianniu-bot-x64.zip",
        "manifest_url": "https://github.com/b8vipvip/qianniu-ai-bot/releases/download/bot-v1.1.600/update.json",
